...
// 4.0. Función declarativa: lee el inventario y fabrica dinámicamente las <option>
// del filtro de categorías. La opción "todos" ya viene fija en el HTML, así que
// aquí solo se agregan las categorías reales, sin repetir ninguna.
function construirOpcionesCategoria() {
    ...
    */
    ...
    inventarioProductos.forEach((producto) => {
        ...
        if (coincideFiltro) {
            ...
            // Botón secundario e independiente: abre el modal con el detalle del producto
            const botonDetalle = document.createElement("button");
            botonDetalle.classList.add("boton", "boton-secundario", "boton-bloque");
...
/* =========================================================================
   4.2. MODAL DE DETALLE DE PRODUCTO
   ========================================================================= */

// Función declarativa: busca el producto por id, escribe su información
// dentro del modal (innerHTML) y le quita la clase "oculto" para mostrarlo.
function mostrarDetalleProducto(idProducto) {
    ...
    modalCuerpo.innerHTML = `
        ...
        <p>${producto.stock > 0 ? `Disponibles: ${producto.stock}` : "Agotado"}</p>
    `;

    modalDetalle.classList.remove("oculto");
}

// Cierra el modal: vuelve a agregarle la clase "oculto"
...
/* =========================================================================
   ...
   //8.1. Función autoejecutable: se ejecuta automáticamente al cargar la página. Inicializa la tienda y actualiza la pantalla.
    ...
    (function iniciarTienda() {
        ...
        // Construcción dinámica de las categorías del filtro
